...
<div class="page">
 ...
 <div class="hero text-center space-y-4">
    ...
    <div class="card">
        <div class="actions">
            @auth
                <a href="{{ route('tenants.dashboard') }}" class="btn btn-dark">Go to Dashboard</a>
            @else
                <a href="{{ route('tenants.register') }}" class="btn btn-dark">Register</a>
                <a href="{{ route('tenants.login') }}" class="btn btn-outline">Log In</a>
            @endauth
        </div>
    </div>
